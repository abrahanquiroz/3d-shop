...
// bg-[url(/cta-banner.jpg)] this tailwind atribute to add background image

const DiscountBanner= () => {
  return (
    <div>
      <div className="container pt-16 pb-16">
          <div className="bg-gray-600  border-stone-950 bg-cover h-[500px] rounded-2xl grid place-items-center"> 
